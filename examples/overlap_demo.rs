...
fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    // 场景 1: 完全覆盖
    println!("场景 1: 完全覆盖");
    set.merge_add(StrRange::new(10..20, "A", true))?;
    ...
    set.merge_add(StrRange::new(10..20, "B", true))?;
    ...
    println!("\n场景 2: 部分覆盖（左侧）");
    set.clear();
    set.merge_add(StrRange::new(10..30, "A", true))?;
    ...
    set.merge_add(StrRange::new(5..20, "B", true))?;
    ...
    set.merge_add(StrRange::new(20..35, "B", true))?;
    ...
    println!("\n场景 4: 中间覆盖（分裂原区间）");
    set.clear();
    set.merge_add(StrRange::new(10..40, "A", true))?;
    ...
    set.merge_add(StrRange::new(20..30, "B", true))?;
    ...
    set.clear();
    set.merge_add(StrRange::new(10..20, "A", true))?;
    set.merge_add(StrRange::new(30..40, "A", true))?;
    ...
    set.merge_add(StrRange::new(15..35, "A", true))?;
    ...
    set.clear();
    set.merge_add(StrRange::new(0..10, "A", true))?;
    set.merge_add(StrRange::new(10..20, "B", true))?;
    set.merge_add(StrRange::new(20..30, "C", true))?;
    println!("初始状态:");
    for info in set.iter() {
        println!(
            "  [{}, {}) kind={}",
    ...
    set.merge_add(StrRange::new(5..25, "D", true))?;
