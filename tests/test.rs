...
fn add_merges_overlaps_and_adjacency() {
    ...
    let expected = [ranges_ext::RangeInfo::new(r(10, 40), (), true)];
    ...
    let expected = [ranges_ext::RangeInfo::new(r(10, 25), (), true)];
    assert_eq!(set.as_slice(), &expected);
}
...
fn add_out_of_order_is_normalized() {
    ...
    let expected = [ranges_ext::RangeInfo::new(r(0, 40), (), true)];
    assert_eq!(set.as_slice(), &expected);
}
...
fn remove_trims_and_splits() {
    ...
    let expected = [
        ranges_ext::RangeInfo::new(r(10, 20), (), true),
        ranges_ext::RangeInfo::new(r(30, 50), (), true),
    ];
    assert_eq!(set.as_slice(), &expected);
    ...
    let expected = [
        ranges_ext::RangeInfo::new(r(12, 20), (), true),
        ranges_ext::RangeInfo::new(r(30, 50), (), true),
    ];
    assert_eq!(set.as_slice(), &expected);
    ...
    let expected = [
        ranges_ext::RangeInfo::new(r(12, 15), (), true),
        ranges_ext::RangeInfo::new(r(45, 50), (), true),
    ];
    assert_eq!(set.as_slice(), &expected);
}
...
fn remove_noop_on_empty_or_non_overlapping() {
    ...
    let expected = [ranges_ext::RangeInfo::new(r(10, 20), (), true)];
    assert_eq!(set.as_slice(), &expected);
}
...
fn only_merge_when_kind_equals() {
    ...
    assert_eq!(set.len(), 2);
    let expected = [
        ranges_ext::RangeInfo::new(r(10, 20), 1, true),
        ranges_ext::RangeInfo::new(r(20, 30), 2, true),
    ];
    assert_eq!(set.as_slice(), &expected);
    ...
    let expected = [
        ranges_ext::RangeInfo::new(r(10, 20), 1, true),
        ranges_ext::RangeInfo::new(r(20, 40), 2, true),
    ];
    assert_eq!(set.as_slice(), &expected);
    ...
    assert_eq!(set.len(), 3);
    let expected = [
        ranges_ext::RangeInfo::new(r(10, 15), 1, true),
        ranges_ext::RangeInfo::new(r(15, 25), 3, true),
        ranges_ext::RangeInfo::new(r(25, 40), 2, true),
    ];
    assert_eq!(set.as_slice(), &expected);
}
...
fn conflict_error_on_non_overwritable() {
    ...
    // 验证原区间未被修改
    assert_eq!(set.len(), 1);
    let expected = [ranges_ext::RangeInfo::new(r(10, 30), 1, false)];
    assert_eq!(set.as_slice(), &expected);
}
...
fn overwritable_ranges_can_be_replaced() {
    ...
    let expected = [
        ranges_ext::RangeInfo::new(r(10, 20), 1, true),
        ranges_ext::RangeInfo::new(r(20, 40), 2, false),
    ];
    assert_eq!(set.as_slice(), &expected);
}
